...
export const operatorDetailsBasedOnStatusService = async (phoneNumber) =>{
  try {
    ...
    // console.log("service" , pendingPatients);
    ...
    // console.log("service" , uploadDocumentsCount);
    ...
    const hospitalAndSchemeDetails = hospitalAndScheme.length

    const response = {
      pendingPatientsCount : pendingPatientsCount,
      uploadDocumentsCount : uploadDocumentsCount,
      hospitalAndSchemeDetails : hospitalAndSchemeDetails
    }
